...
def texture_preservation(pp: PreprocessedImage) -> MetricResult:
    ...
    # Uniform image guard: no detail/flat distinction means no texture defect
    ...
    return MetricResult(
        ...
        metadata={"texture_to_flat_variance_ratio": round(ratio, 2) if not is_uniform else 0.0},
    )
